> [!NOTE]
> This repository has been archived. For a more up-to-date version of the route advisor, visit [https://github.com/meatlayer/ets2-mobile-route-advisor](https://github.com/meatlayer/ets2-mobile-route-advisor).
